...
<head>
	...
	<link rel="stylesheet" type="text/css" href="public/css/list_product.css">
...
<body>
	<div class="main">
		...
		<div class="section">
			<div id="panel" style="background-image: url(public/images/panel.JPG); background-repeat: repeat-x;text-align: center;">
			...
			<div class="content">
				<div class="left">
					...
					<div style="width: 100% ;background-color: blue; height: 275px">
						<img src="public/images/20_off_all.JPG" alt="" style="width: 100%; height: 100%">
					</div>
				</div>
					...
					<div class="category">
						...
						<div class="category_panel">
							...
							<div class="category_panel_detail">
								<a href="#">
									<img src="public/images/category_panel.JPG" alt="">
								</a>
								Túi cỡ nhỏ
							</div>
							<div class="category_panel_detail">
					...
					<div class="content_product">
						...
						<div class="list_product">
							<div class="product_detail" id="product_1">
								<img src="public/images/74-home_default.jpg" alt="" style="width: 100%; height: 350px">
							...
							<div class="product_detail" id="product_2">
								<img src="public/images/41-home_default.jpg" alt="" style="width: 100%; height: 350px">
								<div style="text-align: center;">
									<span class="fa fa-star checked"></span>
									<span class="fa fa-star checked"></span>
									<span class="fa fa-star checked"></span>
								...
								<div style="text-align: center;">
									...
									<div class="bold">
										<a href="#">
										<div id="bold_radius" style="background: red"
										alt="red"></div>
										</a>
										<a href="#">
										<div id="bold_radius" style="background: blue"></div></a>
							...
							<div class="product_detail" id="product_3">
								<img src="public/images/33-home_default.jpg" alt="" style="width: 100%; height: 350px">
								<div style="text-align: center;">
									<span class="fa fa-star checked"></span>
									<span class="fa fa-star checked"></span>
									<span class="fa fa-star checked"></span>
