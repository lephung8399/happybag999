...
<link href="{{asset('asset_ad/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all">
<!-- Custom Theme files -->
...
<!--static chart-->
<script src="{{asset('asset_ad/js/Chart.min.js')}}"></script>
<!--//charts-->
<!-- geo chart -->
    ...
    <!--<script src="lib/html5shiv/html5shiv.js"></script>-->
     <!-- Chartinator  -->
    <script src="{{asset('asset_ad/js/chartinator.js')}}" ></script>
...
<!--skycons-icons-->
<script src="{{asset('asset_ad/js/skycons.js')}}"></script>
<!--//skycons-icons-->
</head>
<body>
...
<div class="chart-layer-2">
	...
	<div class="col-md-6 chart-layer2-right">
	        ...
	        <div class='bar_group'>
				...
				<script src="{{asset('asset_ad/js/bars.js')}}"></script>
    ...
    <div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu" >
					...
					<li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>Order</span><span class="fa fa-angle-right" style="float: right"></span></a>
...
<!--scrolling js-->
		<script src="{{asset('asset_ad/js/jquery.nicescroll.js')}}"></script>
		<script src="{{asset('asset_ad/js/scripts.js')}}"></script>
		<!--//scrolling js-->
<script src="{{asset('asset_ad/js/bootstrap.js')}}"> </script>
