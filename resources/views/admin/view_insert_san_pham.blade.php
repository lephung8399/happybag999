...
<form action="{{ route('admin.process_insert') }}" method="POST" enctype="multipart/form-data">
	{{csrf_field()}}
	<b>Tên sản phẩm:</b><input type="text" name="ten_san_pham" class="form-control" style="width: 50%">
	<br>
	...
	<br>
	<p></p>
	<b>Kiểu dáng:</b><input type="text" name="kieu_dang" class="form-control" style="width: 50%">
	<br>
