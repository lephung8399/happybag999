...
<html lang="en">
   ...
   <head>
      ...
      <link href="http://student.zent.edu.vn/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
      <link href="http://student.zent.edu.vn/assets/global/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
      <link href="http://student.zent.edu.vn/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
      <link href="http://student.zent.edu.vn/assets/global/plugins/uniform/css/uniform.default.css" rel="stylesheet" type="text/css" />
      <link href="http://student.zent.edu.vn/assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet" type="text/css" />
      <!-- END GLOBAL MANDATORY STYLES -->
      <!-- BEGIN PAGE LEVEL PLUGINS -->
      <link href="http://student.zent.edu.vn/assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
      <link href="http://student.zent.edu.vn/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
      <!-- END PAGE LEVEL PLUGINS -->
      <!-- BEGIN THEME GLOBAL STYLES -->
      <link href="http://student.zent.edu.vn/assets/global/css/components-md.min.css" rel="stylesheet" id="style_components" type="text/css" />
      <link href="http://student.zent.edu.vn/assets/global/css/plugins-md.min.css" rel="stylesheet" type="text/css" />
      <!-- END THEME GLOBAL STYLES -->
      <!-- BEGIN PAGE LEVEL STYLES -->
      <link href="http://student.zent.edu.vn/assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
      <link href="http://student.zent.edu.vn/css/toastr.min.css" rel="stylesheet" />
      ...
      <!-- favicon -->
      <!-- <link rel="shortcut icon" href="http://student.zent.edu.vn/img/favicon.ico" /> -->
   ...
   <!--  <div class="logo">
        <a href="http://student.zent.edu.vn/">
        
        <img src="http://student.zent.edu.vn/img/logo-new.png" alt="" /> </a>
    </div> -->

    <div class="content">
        <div class="login-form">
            <form id="form-login"  method="POST" role="form" style="top: 47%;" action="" >
              {{csrf_field()}}
                <input type="hidden" >
               ...
               <!--  <div class="alert alert-danger">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" id="email" placeholder="Yourmail@email.vn" name="email" value="" />
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" id="password" placeholder="Password" name="password" />
                ...
                <!-- <div class="create-account">
                    <p>
                        <a href="http://student.zent.edu.vn/register" id="register-btn" class="uppercase">Tạo Tài Khoản</a>
                    </p>
                </div> -->
            </form>
        </div>
...
<script>
    ...
    TweenMax.set(armR, {x: -93, y: 220, rotation: -105, transformOrigin: "top right"});
      ...
      <div class="copyright" style="font-size: 15px;"> 2019 © Copy Software. </div>
      <!--[if lt IE 9]>
      <script src="../assets/global/plugins/respond.min.js"></script>
      <script src="../assets/global/plugins/excanvas.min.js"></script> 
      <![endif]-->
      <!-- BEGIN CORE PLUGINS -->
      <script src="http://student.zent.edu.vn/assets/global/plugins/jquery.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/assets/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/assets/global/plugins/js.cookie.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/assets/global/plugins/jquery.blockui.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/assets/global/plugins/uniform/jquery.uniform.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript"></script>
      <!-- END CORE PLUGINS -->
      <!-- BEGIN PAGE LEVEL PLUGINS -->
      <script src="http://student.zent.edu.vn/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
      <!-- END PAGE LEVEL PLUGINS -->
      <!-- BEGIN THEME GLOBAL SCRIPTS -->
      <script src="http://student.zent.edu.vn/assets/global/scripts/app.min.js" type="text/javascript"></script>
      <!-- END THEME GLOBAL SCRIPTS -->
      <!-- BEGIN PAGE LEVEL SCRIPTS -->
      <script src="http://student.zent.edu.vn/assets/pages/scripts/login.min.js" type="text/javascript"></script>
      <script src="http://student.zent.edu.vn/js/jqueryValidate/jquery.validate.js"></script>
      <script type="text/javascript" src="http://student.zent.edu.vn/new_js/toastr.min.js"></script>
   ...
   <script>
      ...
      $('#form-login').on('click', function() {
        ...
        function loginSubmit() {
            ...
            $.ajax({
                url: 'http://student.zent.edu.vn/login',
                type: "get",
                data: {
                    'email':  $('#email').val(),
                ...
                success:function(res){
                    ...
                    if (res.is_locked == true) {
                      ...
                      //   }, 4000);
                        toastr.error('Cảnnh báo! Tài khoản của bạn đã bị khóa, vui lòng liên hệ qua hotline 0868 901 456 nếu bạn cần trợ giúp');
                ...
                error:function(error) {
                    ...
                    if (error.responseJSON.errors != undefined) {
                        if (error.responseJSON.errors.email != undefined) {
                            $('#error').text(error.responseJSON.errors.email[0]);
                        } else if (error.responseJSON.errors.password != undefined) {
                            $('#error').text(error.responseJSON.errors.password[0]);
                        }
